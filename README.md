...
**What this repo is:**
After obtaining my OSCP, as preparation for the OSCE and OSEE certification I challenged myself to re-write 50 proof of concepts for pre-existing exploits in software, all of which are Windows based. 
